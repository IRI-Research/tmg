...
REGISTERED_OPERATIONS = [ ('transcode', 'Transcode'),
                          ('shotdetect', 'Detect shots') ]
...
class Process(models.Model):
    ...
    operation = models.CharField(max_length=255, help_text='Operation class identifier', choices=REGISTERED_OPERATIONS)
